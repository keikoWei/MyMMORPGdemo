...
public abstract class PaginatedMenu extends AbstractMenu {
    ...
    public void addMenuBorder() {
        inventory.setItem(48, makeItem(Material.DARK_OAK_BUTTON, ChatColor.GREEN + "上一頁"));

        inventory.setItem(49, makeItem(Material.BARRIER, ChatColor.DARK_RED + "關閉選單"));

        inventory.setItem(50, makeItem(Material.DARK_OAK_BUTTON, ChatColor.GREEN + "下一頁"));
